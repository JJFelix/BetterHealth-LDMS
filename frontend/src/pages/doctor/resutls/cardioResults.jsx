...
const CardioResults = ({results}) =>{
    ...
    const {values, handleChange, handleSubmit} = useFormik({
        initialValues: {
            ...
            magnesiumContent: results.recommendation2,
            fat: results.recommendation3,
            sodiumContent: results.recommendation4,
    ...
    return(
        <>
            <h5><i>Cardion Risk Score: { Math.round(results.riskScore * 100)} %</i></h5>
            <br/>
            ...
            <form>
                ...
                <div className="row mb-3">
                    <label for="sodiumContent" className="col-sm-6 col-form-label">Sodium Content </label>
                    <div className="col-sm-6">
                        <input type="text" className="form-control" id="sodiumContent" name="sodiumContent" value={values.sodiumContent} onChange={handleChange}/>
                    </div>
                </div>
                <div className="row mb-3">
