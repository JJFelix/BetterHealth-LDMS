...
const DiabetesResults = ({results}) =>{
    ...
    const {values, handleChange, handleSubmit} = useFormik({
        initialValues: {
            ...
            potassiumContent: results.recommendation5,
            fiberContent: results.recommendation4,
    ...
    return(
        <>
            <h5><i>Diabetes Risk Score: { Math.round(results.riskScore * 100)} %</i></h5>
            <br/>
            ...
            <form>
                ...
                <div className="row mb-3">
                    <label for="potassiumContent" className="col-sm-6 col-form-label">Potassium Content </label>
                    <div className="col-sm-6">
                        <input type="text" className="form-control" id="potassiumContent" name="potassiumContent" value={values.potassiumContent} onChange={handleChange}/>
                    </div>
                </div>
                <div className="row mb-3">
