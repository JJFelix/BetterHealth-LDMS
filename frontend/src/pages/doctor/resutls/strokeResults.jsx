...
const StrokeResults = ({results}) =>{
    ...
    return(
        <>
            <h5><i>Stroke Risk Score: { Math.round(results.riskScore * 100)} %</i></h5>
            <br/>
            ...
            <form>
                ...
                <div className="row mb-3">
                    ...
                    <div className="col-sm-6">
                        <input type="text" className="form-control" id="sodiumContent" name="potassiumContent" value={values.sodiumContent} onChange={handleChange}/>
                    </div>
                </div>
                <div className="row mb-3">
